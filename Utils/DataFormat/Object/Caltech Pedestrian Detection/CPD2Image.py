...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Change Caltech Pedestrian Detection Dataset .seq file to images!",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Caltech Pedestrian Detection Dataset set file",
    ...
    parser.add_argument(
        ...
        type=str,
        default="./CPD_images",
        help="Caltech Pedestrian Detection Dataset output path to get images",
