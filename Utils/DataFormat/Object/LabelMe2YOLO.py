...
def labelme2yolo(input_path: str, 
                 output_path: str, 
    ...
    for label_file in tqdm(files, desc='Changing LabelMe json format to YOLO format!', unit='jsons'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Change LabelMe json dataset format to yolo dataset format! Please Change the OBJECT_DICT in PYTHON FILE for your class!", epilog="Hello! AI dataset! Hummmm....")
    parser.add_argument('-i', '--input_path', type=str, required=True, help='the file input path of LabelMe json format to yolov5 format!', metavar='labelme_json_input_path')
